...
function fakeScryfallBulkDataResponse(string $downloadUri = 'https://data.scryfall.io/default-cards/default-cards.jsonl.gz', ?string $gzContent = null): void
{
    Http::fake([
...
{
    $lines = array_map(fn (array $card) => json_encode($card), $cards);
